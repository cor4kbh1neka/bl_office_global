...
class HistoryTransaksi extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'store:history-transaksi';
    ...
    public function handle()
    {
        ...
        $redisKeyOldHistory = 'olddatahistorytrans';
        ...
        $newRequest = new Request([
            'getdate' => 'olddatahistorytrans',
            'fromdate' => $fromdateyesterday,
            'todate' => $todatelastmonth,
        ]);

        $data = app()->call('App\Http\Controllers\ApiController@old_datahistorytrans', ['request' => $newRequest]);
