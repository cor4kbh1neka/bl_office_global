...
class StoreOldDataOneMonth extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        $fromdateOneMonth = Carbon::now()->subWeek()->startOfDay()->format('Y-m-d'); // 1 minggu lalu dari jam 00:00
        $todateOneMonth = Carbon::now()->subDay()->endOfDay()->format('Y-m-d'); // Kemarin sampai jam 23:59
