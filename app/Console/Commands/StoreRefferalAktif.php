...
class StoreRefferalAktif extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'store:refferal-aktif';
    ...
    public function handle()
    {
        ...
        $redisKeyOldHistory = 'olddatahistoryreffaktif';
        ...
        $newRequest = new Request([
            'getdate' => 'olddatahistoryreffaktif',
            'fromdate' => $fromdateyesterday,
            'todate' => $todatelastmonth,
        ]);

        $data = app()->call('App\Http\Controllers\ApiController@old_datahistoryreffAktif', ['request' => $newRequest]);
