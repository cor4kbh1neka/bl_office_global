...
class winlosbalance extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'store:winlosbalance';
    ...
    public function handle()
    {
        ...
        $redisKeyOldHistory = 'olddatahistorywinlosbal';
        ...
        $newRequest = new Request([
            'getdate' => 'olddatahistorywinlosbal',
            'fromdate' => $fromdateyesterday,
            'todate' => $todatelastmonth,
        ]);

        $data = app()->call('App\Http\Controllers\ApiController@old_datahistorywinlossbalance', ['request' => $newRequest]);
