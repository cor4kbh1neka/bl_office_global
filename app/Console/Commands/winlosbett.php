...
class winlosbett extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'store:winlosbett';
    ...
    public function handle()
    {
        ...
        $redisKeyOldHistory = 'olddatahistorywinlosbet';
        ...
        $newRequest = new Request([
            'getdate' => 'olddatahistorywinlosbet',
            'fromdate' => $fromdateyesterday,
            'todate' => $todatelastmonth,
        ]);

        $data = app()->call('App\Http\Controllers\ApiController@old_datahistorywinlosbet', ['request' => $newRequest]);
