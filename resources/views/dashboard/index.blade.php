...
@section('container')
    ...
    <div class="sec_table">
        <div class="secgrouptitle">
            <h2>{{ $title }}</h2>
            <form action="/dashboard" method="GET" class="getdata">
        ...
        @if ($is_maintenance)
            <div class="maintenance-dashboard">
                <div class="announcement">
                    <h1>Maintenance</h1>
                    <span>
                        <span class="highlight">Setiap jam 00:00 s/d 01:00</span> khusus menu <span
                            class="highlight">(DASHBOARD)</span> tidak dapat diakses. Untuk <span
                            class="highlight">(MENU)</span> lain tetap dapat diakses seperti
                        biasa.
                    </span>
                    <p>Terimakasih atas pengertiannya.</p>
                </div>
            </div>
        @else
                ...
                <div class="ccgrouplistsecdashboard">
                    {{-- @if($getdate == 'yesterday') --}}
                        <div class="groupstatusagent">
                            ...
                            <div class="listdatagrouplsmid">
                                <span class="detailtitle">total outstanding</span>
                                <span class="countdetail">{{ $total_outstanding }}</span>
                            </div>
                            <div class="listdatagrouplsmid">
                                <span class="detailtitle">total coin outstanding </span>
                                <span class="countdetail nominal" data-value="{{ $total_coin_outstanding }}"></span>
                            </div>
                        </div>
                    {{-- @endif --}}
                    ...
                    <div class="grouplistsecdashboard">
                        <div class="listsecdashboard">
                            ...
                            <div class="groupdatalistdashboard deposit">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                    ...
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1.5" d="M3 16.5L9 10l4 6l8-9.5" />
                                </svg>
                            </div>
                            <div class="groupdatalistdashboard deposit">
                                <div class="listdatagrouplsmid">
                            ...
                            <div class="groupdatalistdashboard">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M4.115 11q-.666 0-1.14-.475q-.475-.474-.475-1.14v-3.27q0-.666.475-1.14q.474-.475 1.14-.475H13V11zm0-1H12V5.5H4.115q-.269 0-.442.173t-.173.442v3.27q0 .269.173.442t.442.173m0 9.5q-.666 0-1.14-.475q-.475-.474-.475-1.14v-3.27q0-.666.475-1.14Q3.449 13 4.115 13H15v6.5zm0-1H14V14H4.115q-.269 0-.442.173t-.173.442v3.27q0 .269.173.442t.442.173M17 19.5V11h-2V4.5h6.27l-2 5.115h1.96zM5 17h1.5v-1.5H5zm0-8.5h1.5V7H5zM3.5 10V5.5zm0 8.5V14z" />
                                </svg>
                            </div>
                            <div class="groupdatalistdashboard bet">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 36 36">
                                    ...
                                    <path fill="currentColor"
                                        d="M12 26.65a2.8 2.8 0 0 1 4.85-1.8L20.71 29l6.84-7.63A16.81 16.81 0 0 0 18 18.55A16.13 16.13 0 0 0 5.5 24a1 1 0 0 0-.2.61V30a2 2 0 0 0 1.94 2h8.57l-3.07-3.3a2.81 2.81 0 0 1-.74-2.05"
                                        class="clr-i-solid clr-i-solid-path-2" />
                                    <path fill="currentColor" d="M28.76 32a2 2 0 0 0 1.94-2v-3.76L25.57 32Z"
                ...
                <div class="listsecdashboard group">
                    ...
                    <div class="groupdatalistdashboard">
                        {{-- @if($getdate == 'yesterday') --}}
                            ...
                            <div class="groupboxlist">
                                <div class="listdatagroupls">
                                    <span class="countdata">{{ number_format($totalmember) }}</span>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".nominal").each(function() {
                ...
                var formattedNominal = "IDR " + parseFloat(nominal).toLocaleString('en', {
