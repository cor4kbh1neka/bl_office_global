...
@section('container')
    <div class="sec_box hgi-100">
        <form action="/linkalternatifds/updatelinkalternatifds" method="POST" enctype="multipart/form-data"
            id="form-linkalternatifds">
            @csrf
            <div class="sec_form">
            ...
            <div class="sec_button_form">
                ...
                <a href="/linkalternatifds" id="cancel"><button type="button" class="sec_botton btn_danger">SUSPEND
                        PLAYER</button></a>
            </div>
        </form>
        ...
        <form action="/linkalternatifds/updatepassword" method="POST" enctype="multipart/form-data" id="form-password">
            @csrf
            <div class="sec_form">
                <div class="sec_head_form">
        ...
        <form action="/linkalternatifds/updateplayer" method="POST" enctype="multipart/form-data"
            id="form-linkalternatifds">
            @csrf
            <div class="sec_form">
                <div class="sec_head_form">
            ...
            <div class="sec_button_form">
                <button class="sec_botton btn_submit" type="submit" id="Contactsubmit">Submit</button>
                <a href="/linkalternatifds" id="cancel"><button type="button"
