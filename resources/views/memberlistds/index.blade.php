        ...
        <div class="secmemberlist">
            <div class="grouphistoryds memberlist">
                ...
                <div class="groupmaksimaldata">
                    <span class="textmaksimaldata">Total Balance : IDR <span
                            class="dataterakhir totalCount">{{ $totalBalance }}</span> from <span class="dataterakhir">
                            {{ $totalMember }} </span> users</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.totalCount').each(function() {
                ...
                if (!isNaN(balance)) {
                    $(this).text(balance.toLocaleString('en-US', {
