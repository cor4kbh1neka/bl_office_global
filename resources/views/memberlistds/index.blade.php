                        ...
                        <tbody>
                            ...
                            @foreach ($data as $index => $d)
                                <tr>
                                    ...
                                    <td>{{ $d->created_at }}</td>
                                    <td>{{ $d->ip_log }}
                                        <a href="/memberlistds/historylog/{{ $d->username }}"
                                            class="iconprofile detailbetingan" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 24 24">
                                                <path fill="currentColor"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.totalCount').each(function() {
                let balance = parseFloat($(this).text());

                if (!isNaN(balance)) {
                    $(this).text(balance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
                }
            });
