...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('pin/validate', [LoginController::class, 'showValidateForm'])->name('pin.validate');
    Route::post('pin/validate', [LoginController::class, 'validatePin'])->name('pin.validate.submit');
    ...
    Route::middleware(['verify.pin'])->group(function () {
        ...
        Route::middleware('member_list')->group(function () {
            ...
            Route::get('/memberlistds/historylog/{username}', [MemberlistdsController::class, 'historylog']);
